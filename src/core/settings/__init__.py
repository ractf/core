...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "core.exception_handler.handle_exception",
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "core.authentication.RactfTokenAuthentication",
    ],
    "DEFAULT_THROTTLE_CLASSES": ["core.throttling.AdminBypassThrottle"],
    ...
    "DEFAULT_PAGINATION_CLASS": "core.pagination.FastPagination",
    "PAGE_SIZE": 100,
}
