...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        challenge2 = Challenge(
            name="test2", category=category, description="a", challenge_type="basic", challenge_metadata={}, flag_type="plaintext", flag_metadata={"flag": "ractf{a}"}, author="dave", score=1000
        )
        challenge3 = Challenge(
            name="test3", category=category, description="a", challenge_type="basic", challenge_metadata={}, flag_type="plaintext", flag_metadata={"flag": "ractf{a}"}, author="dave", score=1000
        )
        challenge1.save()
        challenge2.save()
        challenge3.save()
